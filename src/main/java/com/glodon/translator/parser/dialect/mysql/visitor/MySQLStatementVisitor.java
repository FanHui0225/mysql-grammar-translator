...
import com.glodon.translator.antlr4.MySQLStatementBaseVisitor;
...
import com.glodon.translator.parser.enums.*;
import com.glodon.translator.parser.segment.dal.VariableSegment;
import com.glodon.translator.parser.segment.ddl.constraint.ConstraintSegment;
import com.glodon.translator.parser.segment.ddl.index.IndexNameSegment;
...
import com.glodon.translator.parser.segment.dml.assignment.ColumnAssignmentSegment;
...
import com.glodon.translator.parser.segment.dml.expr.simple.ParameterMarkerExpressionSegment;
...
import com.glodon.translator.parser.segment.dml.order.item.ExpressionOrderByItemSegment;
import com.glodon.translator.parser.segment.dml.order.item.IndexOrderByItemSegment;
...
import com.glodon.translator.parser.segment.dml.pagination.limit.NumberLiteralLimitValueSegment;
import com.glodon.translator.parser.segment.dml.pagination.limit.ParameterMarkerLimitValueSegment;
...
import com.glodon.translator.parser.segment.generic.*;
...
public abstract class MySQLStatementVisitor extends MySQLStatementBaseVisitor<ASTNode> {
    ...
    @Override
    public final ASTNode visitParameterMarker(final MySQLStatementParser.ParameterMarkerContext ctx) {
        return new ParameterMarkerValue(parameterMarkerSegments.size(), ParameterMarkerType.QUESTION);
    }

    @Override
    public final ASTNode visitLiterals(final MySQLStatementParser.LiteralsContext ctx) {
